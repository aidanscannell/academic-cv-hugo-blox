...
publication: In The Twelth International Conference on Learning Representations (ICLR)
...
hugoblox:
  ids:
    doi: 10.48550/arXiv.2403.10929

# Custom links
links:
  - type: pdf
    url: https://openreview.net/pdf?id=2dhxxIKhqz
  - type: poster
    url: poster.pdf
  - type: code
